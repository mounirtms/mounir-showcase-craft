        ...
        function(t, e, n){
            ...
            var r = n(1),
                ...
                c = function(t, e, n){
                    ...
                    for (s in h && (n = e), n){
                        l = ((f = !v && g && void 0 !== g[s]) ? g : n)[s], p = m && f ? a(l, r) : y && 'function' == typeof l ? a(Function.call, l) : l, g && u(g, s, l, t & c.U), b[s] != l && i(b, s, p), y && E[s] != l && (E[s] = l);
                    }
                };
            ...
            (function(e){
                for (var r = n(90), o = 'undefined' == typeof window ? e : window, i = [
                    'moz',
                    'webkit'
                ], u = 'AnimationFrame', a = o['request' + u], c = o['cancel' + u] || o['cancelRequest' + u], s = 0; !a && s < i.length; s++){
            ...
            var r = n(8),
                ...
                c = function(){
                    var t,
                        e = n(37)('iframe'),
                        r = i.length;
                    for (e.style.display = 'none', n(64)
                        .appendChild(e), e.src = 'javascript:', (t = e.contentWindow.document).open(), t.write('<script>document.F=Object<\/script>'), t.close(), c = t.F; r--;){
            ...
            var r = n(1),
                ...
                J = function(t, e, n){
                    return t === V && J(U, e, n), g(t), e = T(e, !0), g(n), o(F, e) ? (n.enumerable ? (o(t, P) && t[P][e] && (t[P][e] = !1), n = O(n, {enumerable: w(0, !1)})) : (o(t, P) || N(t, P, w(1, {})), t[P][e] = !0), B(t, e, n)) : N(t, e, n);
                },
                W = function(t, e){
                    g(t);
                ...
                X = function(t){
                    for (var e, n = t === V, r = M(n ? U : E(t)), i = [], u = 0; r.length > u;){
            ...
            for (var et = A(v.store), nt = 0; et.length > nt;){
                d(et[nt++]);
            }
            u(u.S + u.F * !H, 'Symbol', {
                for: function(t){
            ...
            t.exports = {
                set: Object.setPrototypeOf || ('__proto__' in {} ? function(t, e, r){
                    try{
                        (r = n(18)(Function.call, n(47)
                            .f(Object.prototype, '__proto__').set, 2))(t, []), e = !(t instanceof Array);
                    }
                    catch (t){
                        e = !0;
                    }
            ...
            var l = function(){
                function t(e, n){
                    ...
                    if (function(t, e){
                        ...
                        return 'string' == typeof r.options.strings ? (r.typeString(r.options.strings)
                                                                        .pauseFor(1500), r) : (r.options.strings.forEach(function(t, e){
                            r.typeString(t), e !== r.options.strings.length - 1 && r.typeString(' '), r.pauseFor(1500);
                        }), r);
                    }), f(this, 'typeString', function(t){
                        return i(t) ? r.typeOutHTMLString(t) : (t.split('')
                                                                 .forEach(function(t){
                        ...
                        var e = u(t),
                            n = e.innerText.split('');
                        return n.length ? (e.innerText = '', r.addEventToQueue(r.eventNames.ADD_HTML_TAG_ELEMENT, {htmlTagElement: e}), n.forEach(function(t){
                        ...
                        return r.addEventToQueue(r.eventNames.REMOVE_ALL, {removingCharacterNode: !1}), r;
                        ...
                        return r.state[o] = n ? [i].concat(c(r.state[o])) : c(r.state[o])
                            .concat([i]), r;
                            ...
                            if (!(e <= ('natural' === r.options.delay ? a(100, 200) : r.options.delay))){
                                ...
                                switch (r.logInDevMode({
                                    ...
                                    case r.eventNames.TYPE_CHARACTER:
                                        ...
                                        f ? f.appendChild(l) : r.state.elements.wrapper.appendChild(l), r.state.visibleNodes = c(r.state.visibleNodes)
                                            .concat([
                                                {
                                    ...
                                    case r.eventNames.REMOVE_CHARACTER:
                                        r.addEventToQueue(r.eventNames.REMOVE_LAST_VISIBLE_NODE, {removingCharacterNode: !0}, !0);
                                        break;
                                    ...
                                    case r.eventNames.ADD_HTML_TAG_ELEMENT:
                                        ...
                                        r.state.elements.wrapper.appendChild(y), r.state.visibleNodes = c(r.state.visibleNodes)
                                            .concat([
                                                {
                                    ...
                                    case r.eventNames.REMOVE_ALL:
                                        for (var m = 0, g = r.state.visibleNodes.length; m < g; m++){
                                            r.addEventToQueue(r.eventNames.REMOVE_LAST_VISIBLE_NODE, {removingCharacterNode: !1}, !0);
                                        }
                                        break;
                ...
                return function(t, e, n){
                ...
                }(t, [
                    {
                        key: 'init',
                        value: function(){
                            this.setupWrapperElement(), !0 === this.options.autoStart && this.options.strings && this.typeOutAllStrings()
                                                                                                                     .start();
                        }
                    },
                    {
            ...
            n(86)('split', 2, function(t, e, r){
                ...
                if ('c' == 'abbc'.split(/(b)*/)[1] || 4 != 'test'.split(/(?:)/, -1).length || 2 != 'ab'.split(/(?:ab)*/).length || 4 != '.'.split(/(.?)(.?)/).length || '.'.split(/()()/).length > 1 || ''.split(/.?/).length){
                    ...
                    r = function(t, e){
                        ...
                        for (a || (r = new RegExp('^' + y.source + '$(?!\\s)', v)); (c = y.exec(n)) && !((s = c.index + c[0].length) > h && (p.push(n.slice(h, c.index)), !a && c.length > 1 && c[0].replace(r, function(){
                            for (l = 1; l < arguments.length - 2; l++){
                                void 0 === arguments[l] && (c[l] = void 0)
                            }
                        }), c.length > 1 && c.index < n.length && u.apply(p, c.slice(1)), f = c[0].length, h = s, p.length >= d));){
